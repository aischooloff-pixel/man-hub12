...
export function PodcastCard({ podcast, onPlay, className, style }: PodcastCardProps) {
  return (
    <div
      className={cn(
        'group relative flex w-[240px] flex-shrink-0 flex-col overflow-hidden rounded-lg bg-card transition-smooth hover:bg-card-elevated shadow-card',
        className
      )}
      style={style}
    >
      ...
      <div className="flex flex-1 flex-col p-3">
        <h3 className="mb-1 line-clamp-2 font-heading text-sm font-semibold leading-tight">
          {podcast.title}
        </h3>
